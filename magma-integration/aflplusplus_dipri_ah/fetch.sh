...
# @DiPri: fetch aflpp-dipri source code.
git clone https://github.com/QRXqrx/aflpp-dipri.git "$FUZZER/repo"
git -C "$FUZZER/repo" checkout magma-1.2

# @DiPri: keep the following identical to aflplusplus build
