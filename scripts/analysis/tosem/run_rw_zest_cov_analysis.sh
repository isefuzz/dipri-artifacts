...
PLOT_TREND_PY="$CUR_DIR/plot_cov_trend_zest.py"
PLOT_DISTRIB_PY="$CUR_DIR/plot_cov_distrib_zest.py"
PLOT_OVERHEAD_PY="$CUR_DIR/plot_dipri_overhead_zest.py"
...
python3 "$RANK_COV_PY" -d "$CSV_PATH" -t 'zest'
